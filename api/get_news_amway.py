...
def get_nutrilite_amway():
    headurl = 'http://www.amwaytoday.com.vn'
    url = 'http://www.amwaytoday.com.vn/health/vn-nutrilite-products.amway.article.grid.json'
    req = requests.get(url)
    data_news = req.json()
    json_result = {
        'messages': [
...
def get_artistry_amway():
    headurl = 'http://www.amwaytoday.com.vn'
    url = 'http://www.amwaytoday.com.vn/beauty-personal-care-products/artistry-products.amway.article.grid.json'
    req = requests.get(url)
    data_news = req.json()
    json_result = {
        'messages': [
